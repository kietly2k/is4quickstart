...
namespace IdentityServer
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            /* 
               The call to MigrationsAssembly is used to inform Entity Framework that the host project will contain the migrations code. 
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // this approach is not ideal to leave in to execute each time the application runs. Can remove this code once database is populated
